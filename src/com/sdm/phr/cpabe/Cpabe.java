...
import com.sdm.phr.cpabe.policy.LangPolicy;
import com.sdm.phr.bswabe.Bswabe;
import com.sdm.phr.bswabe.BswabeCph;
import com.sdm.phr.bswabe.BswabeCphKey;
import com.sdm.phr.bswabe.BswabeElementBoolean;
import com.sdm.phr.bswabe.BswabeMsk;
import com.sdm.phr.bswabe.BswabePrv;
import com.sdm.phr.bswabe.BswabePub;
import com.sdm.phr.bswabe.SerializeUtils;
...
public class Cpabe {
	...
	public void enc(String pubfile, String policy, String inputfile,
         ...
         * @throws Exception 
         */
        public byte[] enc(String pubfile, String policy, String pt2ct) 
                                                            throws Exception {
		BswabePub pub;
		BswabeCph cph;
		BswabeCphKey keyCph;
		...
		plt = pt2ct.getBytes();
		aesBuf = AESCoder.encrypt(m.toBytes(), plt);
		return Common.writeCpabeFile(cphBuf, aesBuf);
	}
	...
	public void dec(String pubfile, String prvfile, String encfile,
         ...
         * @throws Exception 
         */
        public byte[] dec(String pubfile, String prvfile, byte[] ct2pt)
                                                        throws Exception {
		byte[] aesBuf, cphBuf;
		byte[] plt;
		byte[] prv_byte;
		...
		/* read ciphertext */
		tmp = Common.readCpabeFile(ct2pt);
		aesBuf = tmp[0];
		cphBuf = tmp[1];
		cph = SerializeUtils.bswabeCphUnserialize(pub, cphBuf);
